...
console.log('I nomi dei personaggi di Star Wars sono: ', charactersNames)
...
console.log('I personaggi femminili di Star Wars sono: ', femaleCharacters)
...
console.log('Personaggi raggruppati secondo il colore degli occhi:', eyeColor)
...
console.log('Prima dei personaggi eliminati.', starWarsCharacters.length)

if (starWarsCharacters[4][6] === femaleCharacters) {
  delete starWarsCharacters[4][6]
}

console.log('Personaggi eliminati.', starWarsCharacters)
console.log('Personaggi eliminati.', starWarsCharacters.length)
